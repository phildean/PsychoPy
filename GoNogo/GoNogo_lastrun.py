...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\pss1pd\\OneDrive - University of Surrey\\Documents\\Programs_Scripts\\PsychoPy\\GoNogo\\GoNogo_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # completed expInfo['pracTrialRepeat'] repeats of 'pracTrials'
    ...
    for thisBlock in blocks:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        text_blockStart2.setText(blockNum)
        ...
        # completed expInfo['mainTrialRepeat'] repeats of 'mainTrials'
    ...
    # completed expInfo['mainBlocks'] repeats of 'blocks'
